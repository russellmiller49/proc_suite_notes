...
def get_span(text, term, occurrence=1):
    ...
    Returns a dictionary with 'text', 'start', and 'end'.
    """
    start = -1
...
Target: 31.2mm Solid lesion, LUL inferior lingula (B5)
...
- Needle: 22G Acquire
- Stations sampled: 10R, 4R, 2L, 2R, 4L
...
- Registration: CT-to-body, error 2.2mm
...
entities_1 = [
    ...
    {"label": "ANAT_LUNG_LOC", **get_span(text_1, "LUL inferior lingula", 1)},
    ...
    {"label": "MEAS_COUNT",     **get_span(text_1, "5", 2)}, # "Number of stations: 5"
    ...
    {"label": "ANAT_LUNG_LOC",  **get_span(text_1, "LUL inferior lingula", 2)},
    ...
    {"label": "MEAS_COUNT",     **get_span(text_1, "2", 3)}, # "TBNA passes: 2"
