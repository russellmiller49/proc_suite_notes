...
Target: 30.2mm Ground-glass lesion, LUL inferior lingula (B5)
...
===============================================
Electronically signed: Sarah Chen, MD
Date: [REDACTED]
==============================================="""
...
entities_1 = [
    ...
    {"label": "MEAS_SIZE", **get_span(text_1, "2.2mm", 1)},
    # Note: LUL/Lingula/B5 appear again in Procedure 2, distinct from Indication
