...
e6 = [
    ...
    {"label": "PROC_ACTION", **get_span(t6, "Ablation", 1)},  # Fixed: Changed from 2 to 1 (case-sensitive)
...
e10 = [
    ...
    {"label": "PROC_ACTION", **get_span(t10, "Ablation", 1)},  # Fixed: Changed from 2 to 1 (case-sensitive)
