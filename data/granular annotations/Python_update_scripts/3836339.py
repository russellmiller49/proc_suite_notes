...
# Set up the repository root (assuming script is running from the 'scripts' directory or similar)
try:
...
entities_2 = [
    ...
    {"label": "DEV_INSTRUMENT", **get_span(text_2, "Neuwave microwave antenna", 1)},
...
entities_9 = [
    {"label": "PROC_ACTION", **get_span(text_9, "tumor destruction", 1)},
