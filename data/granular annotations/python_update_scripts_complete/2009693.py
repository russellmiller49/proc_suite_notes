...
# Set up the repository root path dynamically
# Assuming this script is located in REPO_ROOT/scripts/ or similar
...
entities_1 = [
    ...
    {"label": "OBS_FINDING", **get_span(text_1, "Good ablation zone", 1)},
...
entities_2 = [
    ...
    {"label": "PROC_METHOD", **get_span(text_2, "Microwave energy", 1)},
...
entities_3 = [
    ...
    {"label": "PROC_METHOD", **get_span(text_3, "Neuwave System", 1)},
    ...
    {"label": "PROC_METHOD", **get_span(text_3, "microwave energy", 1)},
    {"label": "PROC_ACTION", **get_span(text_3, "destroy", 1)},
...
entities_7 = [
    ...
    {"label": "PROC_ACTION", **get_span(text_7, "destroyed", 1)},
