...
# Logic: Assumes this script is running within the 'scripts' or similar subdirectory
# and we need to point to the project root to import utility modules.
file = Path(__file__).resolve()
parent, root = file.parent, file.parents[1]
sys.path.append(str(root))

# Import the utility function from the project structure
try:
    from scripts.add_training_case import add_case
except ImportError:
    # Fallback for testing environments where the module structure might differ
    print("WARNING: Could not import 'add_case'. Ensure the script is run from the correct directory.")
    def add_case(case_id, text, entities, root_path):
        print(f"Mock processing case: {case_id}")
...
entities_2 = [
    {"label": "PROC_ACTION", **get_span(text_2, "Bronchoscopic Microwave Ablation", 1)},
...
entities_6 = [
    {"label": "PROC_ACTION", **get_span(text_6, "Bronchoscopic microwave ablation", 1)},
...
entities_8 = [
    ...
    {"label": "PROC_METHOD", **get_span(text_8, "microwave energy", 1)},
...
entities_9 = [
    {"label": "PROC_ACTION", **get_span(text_9, "Bronchoscopic tumor destruction", 1)},
    {"label": "PROC_METHOD", **get_span(text_9, "Microwave energy", 1)},
...
entities_10 = [
    ...
    # Fixed: "Ablation" (Capitalized) appears only once in text_10 (at "Ablation: 60W...").
    # Changed occurrence from 2 to 1.
