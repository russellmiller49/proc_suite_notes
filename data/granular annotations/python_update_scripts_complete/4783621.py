...
entities_2 = [
    ...
    {"label": "PROC_ACTION", **get_span(text_2, "recanalization", 1)},
...
entities_5 = [
    ...
    {"label": "MEDICATION", **get_span(text_5, "propofol", 1)},
...
entities_6 = [
    ...
    {"label": "PROC_METHOD", **get_span(text_6, "HFJV", 1)},
...
entities_7 = [
    ...
    {"label": "PROC_METHOD", **get_span(text_7, "TIVA", 1)},
...
entities_9 = [
    ...
    {"label": "PROC_ACTION", **get_span(text_9, "excised mechanically", 1)},
...
entities_10 = [
    ...
    {"label": "PROC_METHOD", **get_span(text_10, "TIVA", 1)},
    ...
    {"label": "DEV_STENT", **get_span(text_10, "Dumon", 1)},
    {"label": "MEAS_VOL", **get_span(text_10, "150 mL", 1)},
    ...
    {"label": "PROC_METHOD", **get_span(text_10, "HFJV", 1)},
    ...
    {"label": "PROC_METHOD", **get_span(text_10, "fluoroscopic guidance", 1)},
    {"label": "MEDICATION", **get_span(text_10, "epinephrine", 1)},
    {"label": "MEAS_VOL", **get_span(text_10, "10mL", 1)},
    ...
    {"label": "SPECIMEN", **get_span(text_10, "Endobronchial tumor debridement", 1)},
    {"label": "OBS_LESION", **get_span(text_10, "squamous cell lung cancer", 2)},
    {"label": "OBS_LESION", **get_span(text_10, "left mainstem obstruction", 1)},
    {"label": "PROC_METHOD", **get_span(text_10, "therapeutic bronchoscopy", 2)},
