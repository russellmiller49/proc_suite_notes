...
def get_span(text, term, occurrence=1):
    ...
    for i in range(occurrence):
        ...
        if start == -1:
             raise ValueError(f"Term '{term}' (occurrence {occurrence}) not found in text: {text[:20]}...")
...
# Case 6 - FIXED CASE SENSITIVITY HERE
...
e6 = [
    {"label": "PROC_ACTION",    **get_span(t6, "Bronchoscopic microwave ablation", 1)}, # Contains lowercase 'ablation'
    ...
    {"label": "PROC_ACTION",    **get_span(t6, "Ablation", 1)}, # Capitalized 'Ablation' is occurrence 1
...
e8 = [
    ...
    {"label": "PROC_METHOD",    **get_span(t8, "microwave energy", 1)},
...
e10 = [
    ...
    {"label": "PROC_ACTION",    **get_span(t10, "Ablation", 1)}, # Capitalized "Ablation" occurrence 1 (previous was lowercase ablation)
